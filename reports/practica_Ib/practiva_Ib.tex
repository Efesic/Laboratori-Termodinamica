...
\begin{Figura}
  ...
  \label{extrapolacio}
\end{Figura}
Amb aquest conjunt de dades $\ln{P_{\text{e}}}$ i $\ln{P_{\text{c}}}$ a la regió de la dreta recalculem els valors $P_{\text{e}}$ i $P_{\text{c}}$ corresponents i apliquem l'Equació \eqref{relacions_pot}. Amb el resultat tornem a graficar els logaritmes, obtenint la Figura \ref{fig:lnP_rad_vs_lnDeltaT}
\begin{Figura}
  \centering
...
\end{Figura}
Comparant amb l'Equació \eqref{ln_Stefan_Boltzmann}
\section{Conclusions}
\section{Annex}
\end{multicols}
\end{document}